...
var gltcore = require('..');
var Networks = gltcore.Networks;
var HDPrivateKey = gltcore.HDPrivateKey;
var HDPublicKey = gltcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = gltcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(gltcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(gltcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      gltcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = gltcore.PublicKey.fromPoint;
      gltcore.PublicKey.fromPoint = function() {
        gltcore.PublicKey.fromPoint = unstubbed;
