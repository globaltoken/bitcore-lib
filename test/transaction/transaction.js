...
var gltcore = require('../..');
var BN = gltcore.crypto.BN;
var Transaction = gltcore.Transaction;
var Input = gltcore.Transaction.Input;
var Output = gltcore.Transaction.Output;
var PrivateKey = gltcore.PrivateKey;
var Script = gltcore.Script;
var Address = gltcore.Address;
var Networks = gltcore.Networks;
var Opcode = gltcore.Opcode;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(gltcore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(gltcore.Script);
