...
var BufferWriter = gltcore.encoding.BufferWriter;
var BufferReader = gltcore.encoding.BufferReader;
...
describe('Output', function() {
  ...
  it('#toObject roundtrip will handle an invalid (null) script', function() {
    ...
    var br = new gltcore.encoding.BufferReader(invalidOutputScript);
